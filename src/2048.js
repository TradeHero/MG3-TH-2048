    ...
    var Renderer = (function () {
        ...
        var Renderer = {
            ...
            drawTile: function (context, grid, tile, coordinates, width, height) {
                ...
                context.font = "bold " + (Metrics.getTileSize(width, height)) / 1.5 + "px Helvetica Neue";
                context.textAlign = "center";
                context.textBaseline = "middle";
                context.fillStyle = assets.tileTextColor[tile.value];
                // Allow for 10px of padding on the bounding box
                context.fillText(assets.stocksMapping[tile.value], textX, textY, width - 10);
            },
    ...
    var Game = (function () {
        var Game = {
            ...
            hasLost: function (grid) {
                return (!Movement.canMove("UP", grid) && !Movement.canMove("DOWN", grid) && !Movement.canMove("LEFT", grid) && !Movement.canMove("RIGHT", grid));
            },
